			...
			<div class="clearfix">
				<div class="bd-left">
					<div class="bdl-item">
						...
						<form action="${ctx}community/savePost" method="post" id="myForm">
							...
							<div class="nt-posted clearfix">
								...
								<div style="width: 650px;float: right;">
									<input type="text" class="form-control" name="contentTitle" datatype="*2-30" nullmsg="请输入帖子标题" errormsg="请输入2到30个字符">
								</div>
							</div>
							<input type="hidden" name="programaCode" value="${plateCode}">
							<div class="nt-posted">
								帖子内容：
...
<jsp:include page="../footer/index.jsp"/>
	...
	function savePost(){
		...
		if(count <= 5000 && count >= 2){
		      alert("发帖成功，进入审核！");
			 $("#myForm").attr("action","${ctx}community/savePost").attr("target","_self").submit()
		}else{
			alert("您的发帖内容须在2-5000个字符！");
			return false;
		}
      ...
      var ue = UE.getEditor('content', {
    	  toolbars: [
    			 ...
    			 ,'backcolor' ,'|','removeformat', '|', 'insertorderedlist', 'insertunorderedlist',
    			  '|', 'selectall', 'cleardoc', 'paragraph','|','fontfamily',
    			  'fontsize', //字号
    	            '|','justifyleft', 'justifycenter' ,'justifyright', 'justifyjustify','|',
    	            'link' ,'unlink' ,'|' ,
    	            '|','preview', 'fullscreen', 'formula',	
     	       	  "unlink","link","cleardoc","simpleupload","insertimage","emotion"]],
          wordCount:false,
