		...
		<div class="main container">
			...
			<div class="location mt60 mb30">
				...
				<c:if test="${not empty plate.programaName}">
					<span style="color: red;"><a href="${ctx}/community/frontIndex">天上社区</a>>${plate.programaName}</span>
				</c:if>
			</div>
			<div class="adv clearfix">
				<div>
					<p>
					    ${udj:subString(plate.programaSummary,15)}
					</p>
				</div>
                <c:choose>
				...
				<div class="issue">
					...
					<c:if test="${isTop==1}">
						<a data-listRule="createTime"
							href="${ctx}community/more/orderBy_createTime/isTop_1.html"
							target="_self">最新发布</a>
					</c:if>
				</div>
				<div class="reply">
					...
					<c:if test="${isTop==1}">
						<a data-listRule="newReply"
							href="${ctx}community/more/orderBy_newReply/isTop_1.html"
							target="_self">最新回复</a>
					</c:if>
				</div>
				<div class="praise">
					...
					<c:if test="${isTop==1}">
						<a data-listRule="mostPraise"
							href="${ctx}community/more/orderBy_mostPraise/isTop_1.html"
							target="_self">被赞最多</a>
					</c:if>
				</div>
				<div class="post-btn">
						...
						<ul class="clearfix">
							...
							<li class="w-examine examine-info">
								...
								<p>
									...
									<span class="reply-num">${post.falsereplynum}</span>
								</p>
							</li>
    ...
    seajs.use(['jquery', 'paginator/0.5/bootstrap-paginator.js'], function ($) {
        var options = {
            ...
            pageUrl: function (type, page, current) {
            	var url  =  "${ctx}community/more/orderBy_${orderBy}/isTop_${isTop}.html";
