...
<div style="background: url('../static/images/find_bg.jpg') no-repeat;background-size: cover;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader( src='../static/images/register_bg.jpg', sizingMethod='scale'); height:800px; padding-top: 200px;">
   <div id="logo"><a href="<%=basePath %>"><img src="${ctxPortal}/assets/icon/logo_link.png"/></a></div>
    <div class="main">
        <div class="header">
            <p>通过手机重置密码</p>        <!-- 通过手机找回密码 -->
        </div>
     <form action="<%=basePath %>portal/clientLog/changPassword" method="post" name="passForm">
        ...
        <div class="clearfix content">
            ...
            <div id="new_password" class="clearfix reg-interface">
                <div class="clearfix" style="position: relative">
                    <span>新密码</span>
                    <input class="form-control" placeholder="请输入您的新密码" name="password" id="password"  maxlength="16" type="password"/>
                </div>
                <div class="clearfix" style="position: relative;">
                    <span>确认密码</span>
                    <input class="form-control" placeholder="请再次输入您的新密码" type="password"  maxlength="16" id="passconfirm"/>
                </div>
            </div>
            <!-- ============ 通过手机找回密码界面 End ============== -->
            <div class="immediately" onclick="submi();">下一步</div>
        </div>
      </form>
    </div>
   </div>
