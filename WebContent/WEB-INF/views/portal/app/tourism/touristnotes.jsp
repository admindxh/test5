							...
							<div class="scenery-content bdl-none">
								<div class="scenery-inner">
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type="text" errormsg="请输入2-30位字母、数字、汉字及常用标点符号" name="contentTitle" datatype="*2-30"   id="contentTitle"  class="form-control input-sm" nullmsg="请输入题目">
										</div>
										<div class="col-sm-3">
											<div class="dropdown">
												<button class="btn" type="button" data-toggle="dropdown">
													<span class="text">请选择攻略类型</span>
												...
												<ul class="dropdown-menu" role="menu" style="min-width: 150px;">
													<c:forEach items="${programsList}" var="pro">
														<li role="presentation" data-name="scenic" data-code="1">
															<a role="menuitem" value="${pro.code }" href="javascript:;">${pro.programaName }</a>
														</li>
													</c:forEach>
												</ul>
											</div>
                                            <input type="hidden" id="programaCode" name="programaCode"  datatype="*" nullmsg="请选择攻略类型">
										</div>
									</div>
									<div class="form-group">
	   			...
	   			callback:function(form){
		    			if(checkPortalUserLongin()){
		    	    		$.ajax(
		    						{
		    							 type:'post',
		    							  url:"${ctx }/tourism/upload/save",
		    							  data:$("#form1").serialize(),
		    							  async:true,
		    							  success:function(){
			    							  	
		    									alert('攻略上传成功，请等待管理员审核!',function(){
