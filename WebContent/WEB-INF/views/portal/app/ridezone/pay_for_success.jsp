...
<div class="content">
    <div class="container">
        <div class="pay-success">
            ...
            <%-- <a class="return_activity" href="${ctx}ride/eqindex/list"><img src="${ctxPortal}/assets/icon/return_activity.png"></a> --%>
            <a class="return_activity" href="${ctx}ride/eqindex/list" target="_blank">返回装备首页</a>
        </div>
    </div>
</div>
<!-- footer -->
