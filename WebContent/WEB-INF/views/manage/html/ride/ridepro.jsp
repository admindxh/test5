            ...
            if (selSpan_len) {
                ...
                if (preview == 1) {
                	$.ajax({
        			 	async: true,
        			    type:'post',
        			    url:'${ctx}/web/imageController/deleteImageBymutiCode?muticode='+'8a2bc8f-22d7-4a3e-5c4b-ae44a584cb85',
...
<div class="main">
    ...
    <div class="muduleManage filament_solid_ddd">
        ...
        <div class="searchManage">
            <button type="button" class="lookup btn-sure" onclick="javascript:window.open('${ctx}/ride/rideIndex')">查看</button>
        </div>
        <!-- 景点设置 { -->
        <div class="show">
            <!-- form1 - form 6{ -->
                    ...
                    <div class="posidSet-unit">
                        ...
                        <div class="left perc60">
                            <div class="formLine">
                                ...
                                <span class="txt-suggest ml20">推荐尺寸：700 * 360</span>
                            </div>
                            <div class="formLine">
                                <label>链接地址:</label>
                                <input class="showTitle toLink" name="name" value="${imageList[0][x-1].name }" type="text">
                            </div>
                        </div>
