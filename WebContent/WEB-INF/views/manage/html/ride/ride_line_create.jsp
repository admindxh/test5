...
<body>
	<!-- main { -->
	<div class="main">
		<form id="saveForm" method="post" action="${ctx}web/rideLine/addRideLine">
			...
			<div class="muduleManage details filament_solid_ddd">
				...
				<div class="contClassify">
					...
					<div class="formLine">
						<label>名称:</label>
						<input type="text" maxlength="30" class="w-260" name="name" id="rideLineName">
						<span class="reqItem">*</span>
					</div>
					<div class="formLine">
						<label>副标题:</label>
						<input type="text" maxlength="30" class="w-260" name="subTitle" id="subTitle">
						<span class="reqItem">*</span>
					</div>
					<div class="formLine">
						<label>报名地址:</label>
						<input type="text" maxlength="200" class="w-260" name="achref" id="achref">
						<span class="reqItem"></span>
					</div>
					...
					<div class="formLine">
						...
						<img id="bannerPreId" src="${ctxManage}/resources/img/ele/loadImg_default_a.jpg" title="缩略图名称" alt="请上传图片" class="va_t" style="width: 1140px;height: 300px;">
						<input id="bannerHiddenId" type="hidden" name="bannerImg">
					</div>
					
					<div class="formLine mt20">
						<label class="pos_r_t5">线路简介:</label>
						<%-- <script id="introduce" class="ueEditor_cont" name="introduce"  style="height:500px;" type="text/plain"></script> --%>
						<textarea id="introduce" name="introduce" cols="70" rows="10"></textarea>
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine mt20">
						...
						<textarea id="summary" name="summary" cols="70" rows="10"></textarea>
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine mt20">
						...
						<textarea id="notice" name="notice" cols="70" rows="10"></textarea>
						<span class="reqItem">*</span>
					</div>
