...
<head>
	...
	<title>骑行专区-骑行路线站点管理-修改站点</title>
...
<body>
	<!-- main { -->
	<div class="main">
		<form id="saveForm" method="post" action="${ctx}web/serviceSite/update">
			...
			<div class="location">
				...
				<span><a href="${ctx}/web/serviceSite/addUI">修改站点</a></span>
			</div>
			...
			<div class="muduleManage details filament_solid_ddd">
				...
				<div class="contClassify">
					...
					<div class="formLine">
						<label>站点名称:</label>
						<input type="text" maxlength="30" class="w-260" value="${site.siteName }" name="siteName" id="rideLineName">
						<span class="reqItem">*</span>
						<label>线路类型:</label>
						<div id="theirMudle"  class="select-base">
							<i class="w-140">${pname}</i>
							<dl>
								<c:forEach var="program" items="${rideList}">
									<dt  inputValue="${program.code}" inputName="ridelineId">${program.name}</dt>
								</c:forEach>
							</dl>
							<input id="proType" type="hidden" value="${pcode }" name="ridelineId"/>
						</div>
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine">
						...
						<img id="bannerPre" 
						<c:if test="${empty site.sitImg}">src="${ctxManage}/resources/img/ele/loadImg_default_a.jpg" </c:if>
						<c:if test="${not empty site.sitImg}">src="${ctx}/${site.sitImg}" </c:if>
						 title="缩略图名称" alt="请上传图片" class="va_t" style="width: 150px;height: 150px;">
						<input id="bannerHiddenId" value="${site.sitImg }" type="hidden" name="sitImg">
					</div>
					<div class="formLine">
						<label>站点序号:</label>
						<input type="text" maxlength="30" value="${site.orderSite }" class="w-260" name="orderSite" id="order">
						<span class="reqItem">*</span>
					</div>
			...
			<div class="contClassify">
					...
					<div class="formLine">
						<label>服务站点名称:</label>
						<input type="text" value="${site.serviceName }" maxlength="30" class="w-260" name="serviceName" id="serviceName">
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine">
						...
						<img id="servicePreId" 
						<c:if test="${empty site.sitImg}">src="${ctxManage}/resources/img/ele/loadImg_default_a.jpg" </c:if>
						<c:if test="${not empty site.sitImg}">src="${ctx}/${site.serviceImg}" </c:if>
						
						 title="缩略图名称" alt="请上传图片" class="va_t" style="width: 120px;height: 76px;">
						<input id="serviceImgHiddenId" type="hidden" value="${site.serviceImg }" name="serviceImg">
					</div>
					
					
					<div class="formLine">
						<label>服务站点电话:</label>
						<input type="text" maxlength="30" value="${site.servicePhone }" class="w-260" name="servicePhone" id="servicePhone">
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine mt20">
						...
						<textarea id="serviceAdress"  name="serviceAdress" cols="70" rows="5">${site.serviceAdress }</textarea>
						<span class="reqItem">*</span>
					</div>
			</div>
			<div class="contClassify">
                ...
                <div class="formLine mt15">
                    <label>编号:</label>
                    <input type="text"  value="${merchantShu[0] }" name="urls" class="w-320  to-link">
            ...
            <div class="contClassify">
                ...
                <div class="formLine mt15">
                    <label>编号:</label>
                    <input type="text"  value="${merchantShu[1] }" name="urls" class="w-320 to-link">
                    <input type="hidden"  name="types"  value="merchantShu">
                </div>
            </div>
			...
			<div class="contClassify">
                ...
                <div class="formLine mt15">
                    <label>编号:</label>
                    <input type="text"  value="${merchantShi[0] }" name="urls" class="w-320  to-link">
            ...
            <div class="contClassify">
                ...
                <div class="formLine mt15">
                    <label>编号:</label>
                    <input type="text"  value="${merchantShi[1] }" name="urls" class="w-320 to-link">
                    <input type="hidden"  name="types"  value="merchantShi">
                </div>
            </div>
            <!-- 新闻三 { -->
            <div class="contClassify">
                ...
                <div class="formLine mt15">
                    <label>编号:</label>
                     <input type="text"  value="${content[0] }" name="urls" class="w-320 to-link">
