            ...
            if (selSpan_len) {
                ...
                if (preview == 1) {
                	$.ajax({
        			 	async: true,
        			    type:'post',
        			    url:'${ctx}/web/imageController/deleteImageBymutiCode?muticode=74ffb15c-0192-41ed-91f5-9ac29a651ee4',
...
<div class="main">
    ...
    <div class="location">
        ...
        <span><a>骑行专区</a> -</span>
        <span><a>装备推荐</a> -</span>
        <span><a href="#" target="_self">骑行装备首页</a></span>
    </div>
    ...
    <div class="muduleManage filament_solid_ddd">
        ...
        <div class="searchManage">
            <button type="button" class="lookup btn-sure" onclick="javascript:window.open('${ctx}ride/eqindex/list')">查看</button>
        </div>
        <!-- 景点设置 { -->
        <div class="show">
            <!-- form1 - form 6{ -->
                    ...
                    <div class="posidSet-unit">
                        ...
                        <div class="left perc60">
                            <div class="formLine">
                                ...
                                <span class="txt-suggest ml20">推荐尺寸：700 * 305</span>
                            </div>
                            <div class="formLine">
                                <label>骑行编号:</label>
                        ...
                        <div class="right mt10 perc40">
                            ...
                            <c:if test="${not empty imageList[0][x-1].url}">
                                 ...
                                 title="缩略图名称" alt="请上传图片" class="style-d" style="width:300px;height:180px;">
