...
<head>
    ...
    <title>看西藏-视频专区信息管理-视频信息添加</title>
...
<div class="main">
    ...
    <div class="location">
        ...
        <span><a href="#" target="_self">视频信息添加</a></span>
    </div>

    <!-- 模块管理 { -->
      <form id="dest-add" action="videocreat" method="post">
       <input type="hidden"  value="${token}" name="token"/>
        
<!--       隐藏域 
		  1. 本地上传的视频，用一张默认图（或上传）
		  2.从七牛网站上取视频，图片在原视频名后加_01.jpg
 -->
    	<input type="hidden" name="contentType" value="3010">
        <!-- 基本信息 { -->
        <div>
            ...
            <div class="filament_solid_ddd ov-au mt30">
                <div class="formLine mt20">
                    ...
                    <input id="destName"  name="contentTitle" type="text" maxlength='30' class="w-260"/>
                    <span class="reqItem">*</span>
                </div>

				<div class="formLine">
                    <label class="w-140">视频:</label>
                    <div onclick="checkUploader()" id="btnuploadfile1" type="button" class="btn-base btn-uploadImg">点击上传视频</div>
                ...
                <div class="formLine">
                    ...
                    <div id="btnuploadfile" type="button" class="btn-base btn-uploadImg">点击上传图片</div>
                    <span class="txt-suggest">推荐尺寸：250 * 200</span>
                    <input id="imgurl" type="hidden" name="title" >
                ...
                <div class="formLine mt10">
                    ...
                    <textarea name="content" id="destIntro" cols="70" rows="10"></textarea>
                    <span class="reqItem">*</span>
                </div>

                <div class="formLine mt20 mb30">
                    <label class="w-140">视频链接:</label>
                    <input id="toLink" name ="description" type="text" class="w-260" value="" />
<!--                     <span class="reqItem">*</span> -->
                </div>
        ...
        <div class="txt-ac mt40">
            <button id="save" class="btn-sure mr40" type="button">添加</button>
            <button class="btn-sure ml20 mr40" onclick="javascript:back()" type="button">取消</button>
        </div>
    </form>
    <!-- } 模块管理 -->
</div>
...
<script type="text/javascript">
function quxiao(){
	location.href='video-infomessage';
	}
    /* 视频名称验证 */
    ...
    $(".seoInfo").blur(function () {
        ...
        valid_txtBox_create(this,(regTest && inputRange(this,2,20) || thisVal == ""),"只能为空或中英文及数字，且长度在2-20","top");
    });
