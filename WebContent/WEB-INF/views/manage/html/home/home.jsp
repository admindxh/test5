...
<html>
	...
	<body>
			...
			<div class="muduleIndex">
				<rimiTag:perm
					...
					<a
						...
						target="_self" class="all-inline mbgc_0">Banner管理</a>
				</rimiTag:perm>
				<rimiTag:perm
				...
				<div class="less-inline">
					<rimiTag:perm url="web/indexGlDtManagerController/saveUI">
						<a href="${ctx }/web/indexGlDtManagerController/saveUI"
							target="_self" class="less-inline-halves mbgc_4 mb12">游西藏攻略管理</a>
					</rimiTag:perm>
					<rimiTag:perm
						...
						<a
							...
							target="_self" class="less-inline-halves mbgc_5">景点管理</a>
					</rimiTag:perm>
				</div>
				<rimiTag:perm
				...
				<rimiTag:perm
					...
					<a
						...
						target="_self" class="all-inline mbgc_8">读西藏管理</a>
				</rimiTag:perm>
				<rimiTag:perm url="web/indexWhMgController/saveUI">
					<a href="${ctx }/web/indexWhMgController/saveUI" target="_self"
						class="all-inline mbgc_9">西藏文化传播管理</a>
				</rimiTag:perm>
				<rimiTag:perm
					...
					<a
						...
						target="_self" class="float-block mbgc_8"> <span>浮<br>窗<br>管<br>理</span>
					</a>
				</rimiTag:perm>
			</div>
			<!-- } 模块管理 -->
		...
		<script src="${ctxManage}/resources/js/home/home.js"
			type="text/javascript"></script>
