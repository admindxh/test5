...
<div class="main">
    ...
    <div class="searchManage">
        <rimiTag:perm url="info-creat.html">
            <a href="info-creat.html" target="_self" class="btn-anchor">新建</a>
        </rimiTag:perm>
        <rimiTag:perm url="deletes.html">
    ...
    <div class="tableManage pos-rela">
        <form id="paramsfrm">
            ...
            <div class="searchTools">
                ...
                <!-- 查询 -->
                <button id="btnsearch" type="button" class="btn-search" ><!--查询--></button>
                ...
                <div class="shortcutSearch">
                    ...
                    <div class="select-base">
                        <input name="contentType" type="hidden" value="1000">
                        <i class="w-110">全部</i>
                        <dl>
                            <dt name="1000">全部</dt>
        ...
        <!-- 数据列表 -->
        <form id="deletefrm" action="infodelete" method="post">
            <table border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr ms-repeat="data">
                    ...
                    <td>
                        ...
                        <a ms-href="${ctx}culture/detail/{{el.code}}.html" target="_new">
            					<span class="maxW460">
            						{{el.contentTitle}}
            					</span>
                        </a>
                    ...
                    <td>
                        <a ms-href="${ctx}culture/detail/{{el.code}}.html" target="_new">前台查看</a>
                        <rimiTag:perm url="info-edit.html">
                            <a
                                    ms-href="info-edit.html?code={{el.code}}">
                                编辑
                            </a>
                        </rimiTag:perm>
                        <rimiTag:perm url="deletes.html">
                            <a href="javascript:void(0);" ms-click="deleteView(el.code)">
                                删除
                            </a>
                        </rimiTag:perm>
                    </td>
