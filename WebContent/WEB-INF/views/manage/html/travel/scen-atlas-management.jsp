...
<head>
    ...
    <title>游西藏-目的地管理-景点信息管理-景点图片集管理</title>
...
<div class="main">
    <form id="" name="">
        ...
        <div class="location">
            ...
            <span><a href="#" target="_self">景点图片集管理</a></span>
        </div>
                ...
                <div class="posidSet-posid show floatfix" ms-important="offUploadView">
                    <div class="floatfix mb100">
                        <div class="float_l mt20 ml35 txt-ac" ms-repeat="data">
                            ...
                            <input class="mt10" type="checkbox" name="imgSelect" ms-attr-value="el.code"/>
                        </div>
                    </div>
                    <!-- 分页 -->
...
<script type="text/javascript">
	...
	function cteateUploder(){
  		...
  		var options_={
			...
			server : contextPath+'/web/viewController/uploadImages',
			runtimeOrder : "flash",
			accept : {extensions : 'jpg,jpeg,bmp,png'},
			formData:{
				destinationCode: '${destinationCode}',
				viewCode: '${viewCode}',
				floderName: 'viewAtlas'
			},
			pick : {
				id:'#pickId'
			},
...
<script type="text/javascript">
	...
	function getoffUploadList(currentPage){
		...
		$.post('${ctx}web/viewController/loadViewAtlas', {type: '<%=Image.ATLAS_OFFICAL%>', viewCode: '${viewCode}', currentPage: currentPage, pageSize: 20}, function(response){
	...
	function getuserUploadList(currentPage){
		...
		$.post('${ctx}web/viewController/loadViewAtlas', {type: '<%=Image.ATLAS_USER%>', viewCode: '${viewCode}', currentPage: currentPage, pageSize: 20}, function(response){
        	...
        	popupLayer(
   			...
   			$(document).one('click', '.sure', function(){
   				...
   				$.ajax({
   					traditional: true,
                    type: 'POST',
                    url: '${ctx}web/viewController/deleteImage' ,
                    data: {codes: params} ,
...
//    				$.post('${ctx}web/viewController/deleteImage', {codes: radioCheck.val()}, function(response){
//    	    			if(response=="success"){
//    	    				msgBox("删除成功！", "pass", 1200);
//    	    				getoffUploadList(1);
//    	    				getuserUploadList(1);
