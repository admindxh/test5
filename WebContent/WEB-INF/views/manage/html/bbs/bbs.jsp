...
<div class="main">
    ...
    <div class="muduleIndex">
        <%--<rimiTag:perm url="web/tssq/banner">
            <a href="${ctx}/web/tssq/banner" target="_self" class="all-inline mbgc_5">Banner管理</a>
        </rimiTag:perm>--%>
        <rimiTag:perm url="web/bbsReplyControoler/saveUI">
            <a href="${ctx }/web/bbsReplyControoler/saveUI" target="_self" class="less-inline mbgc_7">最赞回复显示管理</a>
        </rimiTag:perm>
    </div><!-- } 模块管理 -->
