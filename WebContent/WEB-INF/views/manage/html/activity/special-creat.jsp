...
<head>
	...
	<title>活动&专题-活动&专题信息管理-新建专题</title>
...
<body>
	...
	<div class="main">
		<form id="saveForm" name="" method="post">
			...
			<div class="location">
				...
				<span><a href="#" target="_self">新建专题</a></span>
			</div>
			...
			<div class="muduleManage details filament_solid_ddd">
				...
				<div class="contClassify">
					...
					<div class="formLine">
						<label>专题名称:</label>
						<input type="text" maxlength="30" class="w-260" name="contentTitle">
						<span class="reqItem">*</span>

						<label>序号:</label>
						<input id="sortNum" type="text" maxlength="7" name="sortNum" value="${maxSortNum }">

					</div>

					<div class="formLine">
						<label>缩略图:</label>
						<input id="hiddenUrlTag" type="hidden" name="tag">
					...
					<div class="formLine">
						...
						<img width="317" height="229" id="preImgTag" src="${ctxManage}/resources/img/ele/loadImg_default_c.jpg" title="缩略图名称" alt="请上传图片" class="va_t">
					</div>
					
					<div class="formLine">
						<label>Banner图:</label>
						<input id="hiddenUrl" type="hidden" name="title">
					...
					<div class="formLine">
						...
						<img id="preImg" src="${ctxManage}/resources/img/ele/loadImg_default_a.jpg"
                             title="缩略图名称" alt="请上传图片" class="va_t" style="width: 1140px;height: 300px;">
					</div>
	...
	<script type="text/javascript">
		function save(){
			...
			form.attr("action", "${ctx }web/specialController/addSpecial");
			form.submit();
		}
		function pre(){
			//$("input[type='file']").attr('disabled',"true");
	...
	<script type="text/javascript">
		...
		function submitForm(call_){
			// 失焦验证
			$("[name='contentTitle'], [name='sortNum'], [name='keywords']").blur();
			/* SEO 验证 */
			$(".seoInfo").blur();
			// 是否上传banner图片
