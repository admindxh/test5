...
<head>
	...
	<title>活动&专题-活动&专题信息管理-新建活动</title>
...
<body>
	...
	<div class="main">
		<form id="saveForm" method="post">
			...
			<div class="location">
				...
				<span><a href="#" target="_self">新建活动</a></span>
			</div>

			<!-- 数据操作 -->
			<div class="searchManage">
				<button type="button" class="btn-sure preview">预览</button><!--  onclick="pre()" -->
				<button type="button" class="btn-sure save1">发布</button><!--  onclick="save()" -->
			</div>
			...
			<div class="muduleManage details filament_solid_ddd">
				...
				<div class="contClassify bt-n">
					...
					<div class="formLine">
						...
						<span class="formEleGroup-squad">
							<input name="description" type="radio" value="1" checked="checked">
							<label class="lbl_check">是</label>
						</span>
						<span class="formEleGroup-squad">
							<input name="description" type="radio" value="0" >
				...
				<div class="contClassify">
					...
					<div class="formLine">
						<label>活动名称:</label>
						<input type="text" maxlength="30" class="w-260" name="name">
						<span class="reqItem">*</span>

						<label>序号:</label>
						<input type="text" name="sortNum" maxlength="7" value="${MaxNum }">
						<!-- <span class="reqItem">*</span> -->
					</div>
					...
					<div class="formLine">
						...
						<!-- <span class="dataVal va_t">
							<textarea id="editor1" name="summary" cols="80" rows="10" class="ckeditor" style="display:inline-block"></textarea>
						</span> -->
						<script id="editor1" class="ueEditor_cont" name="summary"  style="height:500px;" type="text/plain"></script>
						<span class="reqItem">*</span>
					</div>
					...
					<div class="formLine">
						...
						<img width="317" height="229" id="imgPreId" src="${ctxManage}/resources/img/ele/loadImg_default_c.jpg" title="缩略图名称" alt="请上传图片" class="va_t">
						<input id="imgHiddenId" type="hidden" name="img">
					</div>
					...
					<div class="formLine">
						...
						<img id="bannerPreId" src="${ctxManage}/resources/img/ele/loadImg_default_a.jpg"
                             title="缩略图名称" alt="请上传图片" class="va_t"
                             style="width: 1140px;height: 300px;">
						<input id="bannerHiddenId" type="hidden" name="bannerImg">
					</div>

					<div class="formLine mt20">
						<label>开始时间:</label>
						<input id="startDate" type="text" maxlength="10" name="startDate1">
						<span class="reqItem">*</span>

						<label>截止时间:</label>
						<input id="endDate" type="text" maxlength="10" name="endDate1">
						<span class="reqItem">*</span>
					</div>
				...
				<div id="applyModule" class="contClassify">
					...
					<div class="formLine">
						...
						<label>名称:</label>
						<input type="text" maxlength="15" class="w-200" name="name1">
					</div>
					<div class="formLine">
						<label class="pos_r_t5">内容:</label>
						<!-- <span class="dataVal va_t">
							<textarea id="apply1" name="summary1" cols="80" rows="10" class="ckeditor" style="display:inline-block"></textarea>
						</span> -->
						<script id="apply1" class="ueEditor_cont" name="summary1"  style="height:500px;" type="text/plain"></script>
					</div>

					<div class="formLine">
						<h3 class="mudle-title">模块二</h3>
						<label>名称:</label>
						<input type="text" maxlength="15" class="w-200" name="name2">
					</div>

					<div class="formLine">
						<label class="pos_r_t5">内容:</label>
						<!-- <span class="dataVal va_t">
							<textarea id="apply1" name="summary2" cols="80" rows="10" class="ckeditor" style="display:inline-block"></textarea>
						</span> -->
						<script id="apply2" class="ueEditor_cont" name="summary2"  style="height:500px;" type="text/plain"></script>
					</div>
					<div class="formLine">
						<h3 class="mudle-title">模块三</h3>
						<label class="pos_r_t5">名称:</label>
						<input type="text" maxlength="15" class="w-200" name="name3">
					</div>

					<div class="formLine">
						<label>内容:</label>
						<!-- <span class="dataVal va_t">
							<textarea id="apply1" name="summary3" cols="80" rows="10" class="ckeditor" style="display:inline-block"></textarea>
						</span> -->
						<script id="apply3" class="ueEditor_cont" name="summary3"  style="height:500px;" type="text/plain"></script>
					</div>
				...
				<div id="payModule" class="contClassify">
					...
					<div class="formLine">
						<label>报名费用:</label>
						<input id="money" name="money" type="text" maxlength="" class="w-110 mr5" value="0">元
						<span class="reqItem">*</span>
					</div>
				</div>
				<!-- }报名费支付相关 -->
				...
				<div id="voteModule" class="contClassify">
					...
					<div class="formLine">
						<label>投票名称:</label>
						<input id="voteName" type="text" class="w-260" name="voteName">
						<span class="reqItem">*</span>
					</div>
					...
					<!--对应显示的选项数-->
					<div class="optionSet formLine" style="margin-left:62px"></div>

					<div class="formLine">
						<label class="pos_r_t5">投票简介:</label>
						<!-- <span class="dataVal va_t">
							<textarea id="editor2" name="voteSummary" cols="80" rows="10" class="ckeditor" style="display:inline-block"></textarea>
						</span> -->
						<script id="editor2" class="ueEditor_cont" name="voteSummary"  style="height:500px;" type="text/plain"></script>
						<span class="reqItem">*</span>
					</div>
				...
				<div class="contClassify">
					...
					<div class="otherMudle mt20">
						...
						<div class="top">
							<div class="formLine">
								<label>模块名称:</label>
								<input id="mudleName-0" name="otherBlock" type="text" class="w-320" maxlength="30">
						...
						<div class="formGroup">
							<!-- 删除按钮 -->
							<button id="delMudle-0" type="button" title="删除" class="btn-delete"></button>
							<!-- 左侧设置 -->
							<div class="left">

								<div class="formLine">
									<label>图片:</label>
									<!-- <button id="otherblockPickId0" type="button" class="btn-base uploadImg">点击上传图片</button> -->
									<div id="otherblockPickId0" class="btn-base uploadImg">点击上传图片</div>
									<span class="txt-suggest">推荐尺寸为大于317 * 229的正方形</span>
								</div>

								<div class="formLine">
									<label>名称:</label>
									<input id="mud_name-0" name="mud_name-0" type="text" class="w-320 otherblock_name" maxlength="30">
								</div>

								<div class="formLine">
									<label>连接:</label>
									<input id="mud_link-0" name="mud_link-0" type="text" class="w-320 otherblock_hyperlink">
								</div>
							</div>
							...
							<div class="right">
								<label>缩略图:</label>
								<img width="221" height="160" id="otherblockPreId0" src="${ctxManage}/resources/img/ele/loadImg_default_c.jpg" title="缩略图名称" alt="请上传图片" class="va_m">
								<input class="otherblock_url" type="hidden" id="otherblockUrlHiddenId0">
							</div>
						</div><!-- } 模块1 -->
					</div>
				...
				<div class="formLine">
					<div class="saveOper">
						<button type="button" class="btn-base mr30">发布</button> onclick="save()"
	...
	<script type="text/javascript">
		...
		//初始化第一个其他模块上传组件
		cteateUploder("otherblockPickId0", "otherblockPreId0", "otherblockUrlHiddenId0", "other", fileSingleSizeLimit, other_compress);
	</script>
	...
	<script type="text/javascript">
		function save(){
			...
			form.attr("action", "${ctx }web/activityController/addActivity");
			form.submit();
		}
		function pre(){
			initEnrollFromName();
	...
	<script type="text/javascript">
		...
		$("[name='name']").blur(function () {
			...
			// 验证信息方法
			valid_txtBox(this, testPass && lenRange, "只能是长度为2-30位的中文、英文和数字常用符号", "top");
		});
		...
		// 报名须知二
		UE.getEditor('apply2').addListener( 'contentChange', function() {
			var ueCont = this.getContentTxt();
			if(ueCont != "") {
				valid_richTxt(this, "#apply2", 2, 300, "内容必须在2-300个字符之间");
			} else {
				removeErrMesg("#apply2");
			}
		});
		...
		// 报名须知三
		UE.getEditor('apply3').addListener( 'contentChange', function() {
			var ueCont = this.getContentTxt();
			if(ueCont != "") {
				valid_richTxt(this, "#apply3", 2, 300, "内容必须在2-300个字符之间");
			} else {
				removeErrMesg("#apply3");
			}
		});
