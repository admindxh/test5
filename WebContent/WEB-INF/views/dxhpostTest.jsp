...
<body>
  ...
  <form action="http://localhost:8080/ctibet/web/passPostController/savePost" method="post" enctype="multipart/form-data">  		
	...
	====================================全部通过审核的帖子========================================
    <table>
       <c:forEach var="post" items="${result.dataList}" varStatus="status">
						<tr>
						    <td>
							...
							<tr><td>
							<button onclick="deleteBatchCodeOrSingle('dataCheck','${ctx}/web/passPostController/deletePost','code')">delete</button>
							</td></tr>
    </table><br/>
    =======================================高级查询================================================
    <!-- 所属版块 -->
