...
/**
 *  游西藏自驾游攻略管理列表 controller
 * @author dengxh
 *
 */
@Controller
@RequestMapping("web/readTibetZjyMgController")
public class ReadTibetZjyMgController extends BaseController{
	...
	public String   dynamicDataListUI(Pager pager,HttpServletRequest request,HttpServletResponse response,ModelMap modelMap){
		...
		//调用查询方法  获取分页对象
		String programCode  = "1b851671-79bf-11e4-b6ce-005056a05bc9";
		...
		listImage  = new ArrayList<Image>();
		return   "manage//html//travel//selfDrive";
	}
	...
	public String    previewManageFront(Image image) {
		...
		return "redirect:/tourism/strage/fontIndexZjyPage";
	}
	...
	public static void setPreviewImageList(List<List<Image>> previewImageList) {
		ReadTibetZjyMgController.previewImageList = previewImageList;
	}
	...
	public static void setListImage(List<Image> listImage) {
		ReadTibetZjyMgController.listImage = listImage;
	}
