...
/**
 *  游西藏骑行攻略管理列表 controller
 * @author dengxh
 *
 */
@Controller
@RequestMapping("web/readTibetQxMgController")
public class ReadTibetQxMgController extends BaseController{
	...
	public String   dynamicDataListUI(Pager pager,HttpServletRequest request,HttpServletResponse response,ModelMap modelMap){
		...
		//调用查询方法  获取分页对象
		String programCode  = "1b8a6d4a-79bf-11e4-b6ce-005056a05bc9";
		...
		listImage  = new ArrayList<Image>();
		return   "manage//html//travel//cycling";
	}
	...
	public @ResponseBody String  previewManageImg(Image image) {
		...
		//imageService.saveImage(image);
		listImage.add(image);
		return "redirect:/tourism/strage/fontIndexQxPage";
	...
	public static void setPreviewImageList(List<List<Image>> previewImageList) {
		ReadTibetQxMgController.previewImageList = previewImageList;
	}
	...
	public static void setListImage(List<Image> listImage) {
		ReadTibetQxMgController.listImage = listImage;
	}
