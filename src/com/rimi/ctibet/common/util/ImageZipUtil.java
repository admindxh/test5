...
public class ImageZipUtil {  
    ...
    /** 
     *  spring multipartFile 等比例压缩图片文件<br> 先保存原文件，再压缩、上传 
     * @param oldFile  要进行压缩的文件 
     * @param newFile  新文件 
     * @param width  宽度 //设置宽度时（高度传入0，等比例缩放） 
     * @param height 高度 //设置高度时（宽度传入0，等比例缩放） 
     ...
     * @return 返回压缩后的文件的全路径 
     */  
    public static String zipImageMultipartFile(MultipartFile multipartFile,File newFile, int width, int height,  
            float quality) {  
    ...
    /** 
     *  spring multipartFile 按宽度高度压缩图片文件<br> 先保存原文件，再压缩、上传 
     * @param oldFile  要进行压缩的文件全路径 
     * @param newFile  新文件 
     * @param width  宽度 
     * @param height 高度 
     ...
     * @return 返回压缩后的文件的全路径 
     */  
    public static String zipWidthHeightImageMultipartFile(MultipartFile multipartFile,File newFile, int width, int height,  
            float quality) {  
        if (multipartFile == null) {  
            return null;  
        }  
