...
public class SDKService_ServiceLocator extends org.apache.axis.client.Service implements SDKService_Service {
    ...
    private java.lang.String sdkServiceAddress = "http://sdk229ws.eucp.b2m.cn:8080/sdk/SDKService";

    public java.lang.String getSDKServiceAddress() {
        return sdkServiceAddress;
    }
    ...
    public SDKClient getSDKService() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
            endpoint = new java.net.URL(sdkServiceAddress);
        }
    ...
    public  com.rimi.ctibet.common.sortmsg.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.rimi.ctibet.common.sortmsg.SDKServiceBindingStub _stub = new com.rimi.ctibet.common.sortmsg.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                SDKServiceBindingStub _stub = new SDKServiceBindingStub(new java.net.URL(sdkServiceAddress), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
